            ...
            modelBuilder.Entity("Kader_System.Domain.Models.Auth.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = "3,2,1",
                            CompanyYearId = 1,
                            ConcurrencyStamp = "34000d78-6c9b-452f-92b8-1530b1f52571",
                            CurrentCompanyId = 3,
                            CurrentTitleId = 1,
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHeALIgPBBeGA8RatftXso/dB09XiWepQmx3Qe9y7JzhLkcOFntvcq7T7Ih7l/9sMQ==",
                            PhoneNumber = "1202200",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "683ddec8-19f9-404e-a29a-36827171f965",
                            TitleId = "1,2",
            ...
            modelBuilder.Entity("Kader_System.Domain.Models.HR.HrContract", b =>
                {
                    b.HasOne("Kader_System.Domain.Models.HR.HrEmployee", "Employee")
                        .WithOne("Contract")
                        .HasForeignKey("Kader_System.Domain.Models.HR.HrContract", "EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
