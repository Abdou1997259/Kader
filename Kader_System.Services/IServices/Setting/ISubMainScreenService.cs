...
public interface ISubMainScreenService
{
    ...
    Task<Response<StCreateSubMainScreenRequest>> CreateSubMainScreenAsync(StCreateSubMainScreenRequest model, string root, string clientName, string moduleName);
