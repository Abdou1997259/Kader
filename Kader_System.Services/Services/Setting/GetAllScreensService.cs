...
namespace Kader_System.Services.Services.Setting
{
    public class GetAllScreensService(IUnitOfWork unitOfWork, IStringLocalizer<SharedResource> sharLocalizer) : IGetAllScreensService
    {
        ...
        public async Task<Response<ScreenLookups>> GetAllScreensAsync(string lang)
        {
            ...
            List<ScreenMainLookup> lookupsForMain = mains.Select(x => new ScreenMainLookup
            {
                Id = x.Id,
            ...
            List<ScreenCatLookup> lookupsForCat = (await unitOfWork.MainScreenCategories.GetSpecificSelectAsync(x => true, select: x => new ScreenCatLookup
            {
                Id = x.Id,
            ...
            List<ScreenSubLookup> lookupsForsub = (await unitOfWork.SubMainScreens.GetSpecificSelectAsync(x => true, select: x => new ScreenSubLookup
            {
                sub_id = x.Id,
