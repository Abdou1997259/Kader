...
public static class SD
{
    ...
    public static class ApiRoutes
    {
        ...
        public class Company
        {
            ...
            public const string DeleteCompanyContractAttachement = "company/deleteAttachment/{id}";
        ...
        public class Employee
        {
            ...
            public const string UpdateEmployeeAttachement = "employee/updateAttachement/{id}";
    ...
    public static class Localization
    {
        ...
        public const string UniqueNationalId = "UniqueNationalId";
        ...
        public const string UniqueEmployeePhone = "UniqueEmployeePhone";
